...
$resolutions   = array(1200, 768, 520); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "img/adaptive_images/"; // where to store the generated re-sized images. Specify from your document root!
